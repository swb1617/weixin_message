...
def send_message(to_user, access_token, city_name, today_date, today_weather, now, today_wind, tomorrow,
                 tomorrow_weather, tomorrow_max, tomorrow_min, tomorrow_wind, daily_love, note_en,note_ch = None):
...
if __name__ == "__main__":
    ...
    # 获取每日一句英语
    note_cn,note_en = get_ciba()
    # 公众号推送消息
    for user in users:
        send_message(user, accessToken, city_name, today_date, today_weather, now, today_wind, tomorrow,
                     tomorrow_weather, tomorrow_max, tomorrow_min, tomorrow_wind, daily_love,note_en)